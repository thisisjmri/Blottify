function addInfo(id){
  ...
  // var promise = new Promise(function(resolve, reject) {
    $.ajax({
      url:'admin_libraries/getResults',
      type: 'post',
      dataType: "json",
      data: {
...
function inForward(){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            // console.log(id);
            $.ajax({
                url:'admin_libraries/setForwarded',
                type: 'post',
                data: {
                  id : id
                },
...
$(document).ready(function(){
  $('#allForward').on("click",function(){
    ...
    if (checkboxes1.length > 0) {
      ...
      $.ajax({
        url:'admin_libraries/forwardAll',
        type: 'post',
        data: {
...
//     document.getElementById("daily").className = "form-group pr-2 pl-2";

//     document.getElementById("monthly").className = "form-group pr-2 pl-2 d-none";
//     document.getElementById("annual1").className = "form-group pr-2 pl-2 d-none";
//     document.getElementById("start").className = "form-group pr-2 pl-2 d-none";
//     document.getElementById("end").className = "form-group pr-2 pl-2 d-none";
//     }
//     else if (filter == 'monthly') {

//     document.getElementById("monthly").className = "form-group pr-2 pl-2";

//     document.getElementById("daily").className = "form-group pr-2 pl-2 d-none";
//     document.getElementById("annual1").className = "form-group pr-2 pl-2 d-none";
//     document.getElementById("start").className = "form-group pr-2 pl-2 d-none";
//     document.getElementById("end").className = "form-group pr-2 pl-2 d-none";
//     }
//     else if (filter == 'annual1') {

//     document.getElementById("annual1").className = "form-group pr-2 pl-2";
...
//     document.getElementById("start").className = "form-group pr-2 pl-2";
//     document.getElementById("end").className = "form-group pr-2 pl-2";
